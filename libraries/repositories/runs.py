...
class Runs(object):
    ...
    def record_run(
        ...
        data = {
            ...
            'num_rooms_searched': num_rooms_searched or 0,
            'kicked_dog': kicked_dog or False,
            'touched_candle': touched_candle or False,
            'cont_wall_contact': cont_wall_contact or 0,
